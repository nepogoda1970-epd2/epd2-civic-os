...
CONTROL = Path("docs/roadmap/EPD2_PROGRAM_CONTROL_REGISTER.md")
MODEL = Path("docs/governance/EPD2_OPEN_TRUST_CORE_COMMERCIAL_OPERATIONS_BOUNDARY_0.1.md")

model = """# EPD² Open Trust Core & Commercial Operations Boundary 0.1
...
if "FIR-OSS-007 — Open Trust Core & Commercial Operations Boundary" not in master:
    master = master.rstrip() + master_add + "\n"
