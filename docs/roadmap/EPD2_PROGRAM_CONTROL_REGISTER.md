...
**Primary implementation:** `API-06 = NEXT` (`API-01 = ACCEPTED / CLOSED`; `API-02 = ACCEPTED / CLOSED`; `API-03 = ACCEPTED / CLOSED`; `API-04 = ACCEPTED / CLOSED`). API-05 must treat exact accepted API-04 C1 SHA-256 `8356ba6f1b0e254f9aa215b4873a1e38f44a47fdac2ac859ff62bd95db999337` as its governed predecessor baseline and requires its own seal and independent authoritative acceptance.
