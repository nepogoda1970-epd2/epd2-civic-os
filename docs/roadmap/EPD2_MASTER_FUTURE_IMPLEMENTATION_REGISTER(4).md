...
This file must be included in every cumulative FINAL PASS archive.
...
**Status:** implemented  
**Current authoritative cumulative baseline:**
...
- cryptographically linked version history;
- access and publication profiles;
...
Every decision automatically becomes a register entry.
