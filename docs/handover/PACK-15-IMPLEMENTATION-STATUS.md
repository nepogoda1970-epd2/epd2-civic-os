...
authoritative run**: a check that passes here has passed against *a*
...
layer, and they were executed — but the isolated voting origin *as an
experience someone uses* is unverified until external CI runs.
