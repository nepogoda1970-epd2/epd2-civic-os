...
| Check 16 — no accepted ADR rewritten                 | `check_adr_set_unchanged`                                          | `ADR-001`–`ADR-043` (excluding the recorded `ADR-007` gap) carry no `0.8.0` mention in `## Status`/`## Date`; `ADR-048`–`ADR-054` are all `proposed`                                         | Passed — same run as above                                                                                                                                                                                                      |
...
| `ADR-048`–`ADR-054` all `proposed`                                                        | Check 16, cross-checked by direct inspection of each ADR's `## Status` block                                                                                                                                |
...
- `ADR-048` through `ADR-054` have moved from `proposed` to `accepted`
