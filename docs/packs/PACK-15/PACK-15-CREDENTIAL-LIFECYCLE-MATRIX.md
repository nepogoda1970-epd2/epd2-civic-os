...
| `requested` | *refused*         | Any verification failure                       | Credential Issuer       | —                            | `AS-03`   |
...
`CredentialIssuanceWindow` governs when a participant may *enter* the
...
*Credential redeemed, participant reports they did not redeem it.*
...
persistence anywhere; and detection of the *patterns* that mass transfer
produces (`T-P15-22`).
