...
| #          | What changed                                                                                                                                                                                                                                                                                                                                                                                                     |
| ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `T-P15-13` | **Timing correlation** now has specified controls with default values rather than a named intention: queued release, batching (120 s), minimum cohort _k_ = 5, uniform release delay 30–300 s, `cohort_wait_max` 3600 s, coarsened timestamps (300 s; ≥ 3600 s for small electorates), randomized voting-side minting delay 5–30 s. Residual risk **reduced and bounded, not eliminated**; `OD-P15-02` is closed |
