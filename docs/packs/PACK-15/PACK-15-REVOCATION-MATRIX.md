...
Not permitted under any condition: revocation on the basis of *how someone
is expected to vote*; revocation of a set selected by any attribute other
...
one it is. It can revoke *a credential* whose reference is presented, or *a
set defined by the fault* — an issuance batch, a context, a window. That
