...
| AC-P15-135 | A batch is released only when it holds at least `minimum_cohort_size` assertions          | Cohort gate                   | VC-03                 | Scheduler design            | A sub-_k_ batch is held                                  | yes          | —          |
