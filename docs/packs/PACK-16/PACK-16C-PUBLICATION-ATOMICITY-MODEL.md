...
| `PA-05` | **The count of accepted-but-uncommitted ballots is never published before closure** — it is a turnout proxy. The _fact_ of the failure is published; the _number_ goes to the Auditor immediately and to the public after closure (`TC-07`) |
