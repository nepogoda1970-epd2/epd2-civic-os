...
| `DRT.1`  | deterministic   | **New in v3.0** — requirements for DRNG *trees*                            |
...
> *"It is thus recommended **not to use a PTG.2-compliant PTRNG 'directly'
...
**Derivation rather than draw.** Per-selection nonces are *derived* from a
