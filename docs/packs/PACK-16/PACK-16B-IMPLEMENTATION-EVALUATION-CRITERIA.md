...
| ----------- | ----------------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| `KC-23`     | Verify that the chosen implementation uses **strong Fiat–Shamir**, *by test against the specification, not by assumption* | `IM-07` (MANDATORY) + `TV-06`, `VC-07` — the test, named  |
