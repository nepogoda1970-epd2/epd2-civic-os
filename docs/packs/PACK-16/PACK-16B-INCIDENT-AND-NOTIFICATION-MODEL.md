...
The transcript already publishes what happened _inside_ the ceremony
...
| ID      | Rule                                                                                                                                                                                                                                        |
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `IN-20` | **Notification is not discretionary.** No role may decide that an event on this list is not worth announcing; the only decisions available are _when_ within the stated bound and _with what wording_ from the governed catalogue           |
...
**EPD²'s position:** the _existence_ and _class_ of a suspicion are always
published within 24 hours; the _evidence_ may be withheld under `IN-23`;
