...
| `ballot_encryption.*`  | 1         |
| `ballot_proof.*`       | 6         |
| `challenge.*`          | 9         | _(7 + 2 from §4B)_                |
| `submission.*`         | 13        | _(12 + 1 from §4B)_               |
| `acceptance.*`         | 6         |
| `publication.*`        | 9         | _(6 + 2 from §4A.3 + 1 from §4B)_ |
| `receipt.*`            | 1         |
| `verification.*`       | 3         | _(1 + 2 from §4A.2)_              |
| `election.*`           | 2         | _(1 + 1 from §4B)_                |
| `archive.*`            | 1         |
| `bulletin_board.*`     | 10        | _(9 from §4A.1 + 1 from §4B)_     |
| `privacy.*`            | 2         | _(1 from §4A.4 + 1 from §4B)_     |
| `election_record.*`    | 1         | _(new — §4A.5)_                   |
| **total**              | **88**    |
