...
> _"If any of the above verification steps fails, guardian G_ℓ complains to
...
> failure._
>
> _One possible way to investigate verification failures is to have all
...
> misbehaving guardian, but might do so.**_
>
> _After possibly excluding or replacing a misbehaving guardian, the key
> generation procedure is started from scratch."_ `[F-12]`
...
its nonce proof is public. So _which_ ciphertext is in dispute is settled,
...
| `CD-18` | The specification's broader suggestion — _all_ guardians releasing _all_ secret information `[F-12]` — is **prohibited**. It is a quorum-equivalent disclosure and `CD-15` supersedes it |
