...
specification states it directly: _"Compromised guardians — whether
instantiated as humans or hardware — cannot compromise the integrity of the
election tallies"_, and _"the role of guardians is to protect
confidentiality of votes"_ `[F-13]`.
...
| --------------------------------- | --------------------------------------------------------------------- | --------------------------------------------- |
| `suspected_exposure`              | Credible indication that material _may_ have been exposed             | Report, anomaly, third-party notification     |
