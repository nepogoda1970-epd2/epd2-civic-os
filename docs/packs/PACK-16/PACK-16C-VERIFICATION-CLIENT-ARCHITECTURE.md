...
| ID | Rule |
| -- | ---- |
| `VC-10` | **Same-device verification alone does not establish cast-as-intended**, and the interface says so. A compromised device can encrypt one thing and display another *and* verify a comforting lie |
