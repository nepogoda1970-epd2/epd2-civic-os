...
| ID      | Rule                                                                                                                                                                                                                                                                                               |
| ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `PT-28` | **The concurrency evidence covers this in-memory store's re-entrant lock only.** The race tests run real OS threads against `ReferenceStore`, whose transaction boundary is a `threading.RLock`. That proves the _logic_ is race-free under the serialisation this store provides                  |
