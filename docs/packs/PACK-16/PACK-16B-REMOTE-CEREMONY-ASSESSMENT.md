...
governs voters applies: _"if the coercer can monitor the voter throughout
the vote casting period, then resistance is futile"_ `[E-46]`. A guardian
...
Permitting the _weakest_ operational form of that component, on evidence
