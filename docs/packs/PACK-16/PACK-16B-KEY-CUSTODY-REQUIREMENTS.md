...
**No product and no vendor is selected here.** Permitted *classes* are
...
| `KU-18`  | An HSM policy requiring *m* operator cards is **not** a threshold in the sense of `KC-01` — it is a control inside one device under one administration (`GI-15`) |
