...
`FC-27` — **The correction closed none of the eight.** It closed three _open
decisions_ (`OD-P16D-01`, `-07`, `-09`) and opened two new ones (`OD-P16D-11`,
...
correction changed a §4 row, it changed the _evidence_ column — what now
...
traceability properties, and `FIR-SEC-002` is about parameter _assurance_.
...
refused: the entry is about parameter _assurance_, and assurance is a
