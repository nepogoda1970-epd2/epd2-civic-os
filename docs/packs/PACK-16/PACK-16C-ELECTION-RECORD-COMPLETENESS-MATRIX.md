...
| How many ballots existed at time _t_ before closure?  | The pre-closure record is a sequence of constant-size commitments; the answer is not in it, deliberately                                                | `TC-29`, `EC-14`                |
...
| `EC-15` | **Row 7 must never be closed.** Publishing enough to answer "how many ballots existed at time _t_" before closure would reintroduce the exact defect this correction removed (`TC-21`)                                                                              |
