...
| ID       | Rule                                                                                                          |
| -------- | ----------------------------------------------------------------------------------------------------------------- |
| `VP-14`  | **The casting service is a validator and a recorder, not a participant.** It holds no key that decrypts anything, and its compromise cannot reveal a choice — only stop or corrupt the *process*, which the board and the record make visible |
