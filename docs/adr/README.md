...
+ ADR review", and canon 19e.16 fixes a *minimum* pairwise
incompatibility baseline that may be made stricter and never relaxed —
which is exactly what ADR-061 does. The nine roles PACK-12 adds are
privileged *operational assignments*, not institutional offices, so no
