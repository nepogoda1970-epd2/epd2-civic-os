...
REQUIRED_PATHS: tuple[str, ...] = (
    ...
    # INFRA-01 — canonical CI acceptance harness. Listing every harness file
    # here means a mandatory piece of the acceptance system cannot silently
    # disappear from a candidate (INFRA01-HI-03).
    ...
    # The three documents the PACK-14 FINAL PASS round adds. Required for
    # the same reason PACK-13's three are: a PASS whose evidence file may
    # silently go missing is a PASS nobody can re-check.
    ...
    # --- PACK-15 (Voting Trust Boundary, Eligibility & Credential
    # Separation; FIR-ROADMAP-005; ADR-089 through ADR-098). PACK-15 adds
    # no new service directory: it extends eligibility-service,
    # credential-service, governance-service and audit-core in place, so
    # `uv.lock` and `package-lock.json` stay byte-identical.
    "contracts/reason-codes/pack-15.yml",
    "docs/adr/ADR-089-ELIGIBILITY-AND-CREDENTIAL-SEPARATION.md",
    "docs/adr/ADR-090-VOTING-TRUST-BOUNDARY.md",
    "docs/adr/ADR-091-MINIMIZED-ELIGIBILITY-ASSERTION.md",
    "docs/adr/ADR-092-VOTING-CREDENTIAL-LIFECYCLE.md",
    "docs/adr/ADR-093-UNLINKABILITY-AND-NON-CORRELATION.md",
    "docs/adr/ADR-094-NO-INTERMEDIATE-TALLY.md",
    "docs/adr/ADR-095-REVOCATION-BEFORE-REDEMPTION.md",
    "docs/adr/ADR-096-VOTING-CLIENT-ISOLATION.md",
    "docs/adr/ADR-097-VOTING-AUDIT-SEPARATION.md",
    "docs/adr/ADR-098-DISPUTE-HANDLING-WITHOUT-BALLOT-LINKAGE.md",
    "docs/handover/PACK-15-SPEC-ADR-REPORT.md",
    "docs/handover/PACK-15-IMPLEMENTATION-STATUS.md",
    "docs/packs/PACK-15/PACK-15-SPECIFICATION.md",
    "docs/packs/PACK-15/PACK-15-ACCEPTANCE-MATRIX.md",
    "docs/packs/PACK-15/PACK-15-THREAT-MODEL.md",
    "docs/packs/PACK-15/PACK-15-SEPARATION-OF-DUTIES-MATRIX.md",
    "docs/packs/PACK-15/PACK-15-ELIGIBILITY-MATRIX.md",
    "docs/packs/PACK-15/PACK-15-ATTRIBUTE-MINIMIZATION-MATRIX.md",
    "docs/packs/PACK-15/PACK-15-ASSERTION-MATRIX.md",
    "docs/packs/PACK-15/PACK-15-CREDENTIAL-LIFECYCLE-MATRIX.md",
    "docs/packs/PACK-15/PACK-15-REVOCATION-MATRIX.md",
    "docs/packs/PACK-15/PACK-15-UNLINKABILITY-MATRIX.md",
    "docs/packs/PACK-15/PACK-15-CROSS-BOUNDARY-DATA-FLOW-MATRIX.md",
    "docs/packs/PACK-15/PACK-15-INTERMEDIATE-TALLY-PROHIBITION-MATRIX.md",
    "docs/packs/PACK-15/PACK-15-AUDIT-SEPARATION-MATRIX.md",
    "docs/packs/PACK-15/PACK-15-FAILURE-MODE-MATRIX.md",
    "docs/packs/PACK-15/PACK-15-EVENT-CATALOG.md",
    "docs/packs/PACK-15/PACK-15-REASON-CODE-CATALOG.md",
    "docs/packs/PACK-15/PACK-15-API-CATALOG.md",
    "docs/packs/PACK-15/PACK-15-FIR-COVERAGE-MATRIX.md",
    "docs/packs/PACK-15/PACK-15-CANON-ASSESSMENT.md",
    "docs/packs/PACK-15/PACK-15-FORM-INVENTORY.md",
    "docs/packs/PACK-15/PACK-15-FIELD-CATALOGUE.md",
    "docs/packs/PACK-15/PACK-15-CONTENT-CATALOGUE-DE.md",
    "docs/packs/PACK-15/PACK-15-WORKFLOW-MATRIX.md",
    "docs/packs/PACK-15/PACK-15-ATTACHMENT-MATRIX.md",
    "docs/packs/PACK-15/PACK-15-RENDITION-SPECIFICATION.md",
    "docs/packs/PACK-15/PACK-15-PRIVACY-RETENTION-MATRIX.md",
    # Contracts: PACK-15 event payload schemas. One file per payload SHAPE,
    # not per event type (the nine `eligibility.*` types share one shape,
    # the ten `voting_credential.*` types share three) - the same
    # convention `identity-event-payload.v1.schema.json` follows. Checked
    # against the real builders by
    # `tests/contract/test_pack15_event_schemas.py`.
    "contracts/events/pack15-eligibility-payload.v1.schema.json",
    "contracts/events/pack15-assertion-payload.v1.schema.json",
    "contracts/events/pack15-assertion-queue-payload.v1.schema.json",
    "contracts/events/pack15-handoff-acceptance-payload.v1.schema.json",
    "contracts/events/pack15-voting-boundary-integrity-payload.v1.schema.json",
    "contracts/events/pack15-voting-credential-payload.v1.schema.json",
    "contracts/events/pack15-credential-redemption-payload.v1.schema.json",
    "contracts/events/pack15-credential-replay-payload.v1.schema.json",
    "tests/contract/test_pack15_event_schemas.py",
    "services/eligibility-service/src/epd2_eligibility_service/voting_trust_exceptions.py",
    "services/eligibility-service/src/epd2_eligibility_service/voting_timing.py",
    "services/eligibility-service/src/epd2_eligibility_service/voting_attributes.py",
    "services/eligibility-service/src/epd2_eligibility_service/voting_eligibility.py",
    "services/eligibility-service/src/epd2_eligibility_service/voting_handoff.py",
    "services/eligibility-service/src/epd2_eligibility_service/voting_assertion_issuer.py",
    "services/eligibility-service/src/epd2_eligibility_service/voting_trust_storage.py",
    "services/eligibility-service/src/epd2_eligibility_service/voting_trust_events.py",
    "services/eligibility-service/tests/test_pack15_voting_trust.py",
    "services/credential-service/src/epd2_credential_service/voting_credentials.py",
    "services/credential-service/src/epd2_credential_service/voting_credential_exceptions.py",
    "services/credential-service/src/epd2_credential_service/voting_credential_storage.py",
    "services/credential-service/src/epd2_credential_service/voting_credential_events.py",
    "services/credential-service/src/epd2_credential_service/voting_credential_application.py",
    "services/credential-service/tests/test_pack15_voting_credentials.py",
    "services/governance-service/src/epd2_governance_service/voting_contexts.py",
    "services/governance-service/tests/test_pack15_voting_contexts.py",
    "services/audit-core/src/epd2_audit_core/voting_evidence_bundle.py",
    "services/audit-core/tests/test_pack15_evidence_bundle.py",
    ...
    # Durable persistence. The migration sets are per **database**, not per
    # service: the identity side keeps its cases and its assertions in two
    # separate files, and the audit streams are split three ways, so the
    # separation is a property of the schema rather than of a policy.
    "packages/python/epd2-core/src/epd2_core/sqlite_migrations.py",
    "services/eligibility-service/migrations/eligibility/0001_eligibility_cases.sql",
    "services/eligibility-service/migrations/assertion-issuer/0001_assertion_issuer.sql",
    "services/eligibility-service/migrations/assertion-issuer/0002_handoff_acceptance.sql",
    "services/eligibility-service/src/epd2_eligibility_service/voting_trust_sql_storage.py",
    "services/eligibility-service/src/epd2_eligibility_service/voting_trust_runtime.py",
    "services/eligibility-service/tests/test_pack15_persistence.py",
    "services/credential-service/migrations/0001_voting_credentials.sql",
    "services/credential-service/migrations/0002_spent_nonce_set.sql",
    "services/credential-service/migrations/0003_redemption_and_replay.sql",
    "services/credential-service/src/epd2_credential_service/voting_credential_sql_storage.py",
    "services/credential-service/src/epd2_credential_service/voting_credential_runtime.py",
    "services/credential-service/tests/test_pack15_persistence.py",
    "services/governance-service/migrations/0001_voting_context_registry.sql",
    "services/governance-service/src/epd2_governance_service/voting_context_sql_storage.py",
    "services/governance-service/tests/test_pack15_persistence.py",
    "services/audit-core/migrations/identity-side/0001_identity_side_audit_streams.sql",
    "services/audit-core/migrations/voting-side/0001_voting_side_audit_streams.sql",
    "services/audit-core/migrations/neutral/0001_neutral_audit_streams.sql",
    "services/audit-core/src/epd2_audit_core/voting_audit_sql_storage.py",
    "services/audit-core/tests/test_pack15_persistence.py",
    "tests/repository/test_pack15_default_binding.py",
    # The versioned API. The generic half is in `epd2-core` because four
    # services need it and no service may import another; the endpoint
    # list stays per service, because that list is the service's contract.
    "packages/python/epd2-core/src/epd2_core/api_contracts.py",
    "services/eligibility-service/src/epd2_eligibility_service/voting_trust_api.py",
    "services/eligibility-service/tests/test_pack15_voting_trust_api.py",
    "services/credential-service/src/epd2_credential_service/voting_credential_api.py",
    "services/credential-service/tests/test_pack15_voting_credential_api.py",
    "services/governance-service/src/epd2_governance_service/voting_context_api.py",
    "services/governance-service/tests/test_pack15_voting_context_api.py",
    "services/audit-core/src/epd2_audit_core/voting_evidence_api.py",
    "services/audit-core/tests/test_pack15_voting_evidence_api.py",
    # Authorization and separation of duties. One module, because a
    # matrix split across services is a matrix nobody can check.
    "services/governance-service/src/epd2_governance_service/voting_authorization.py",
    "services/governance-service/tests/test_pack15_voting_authorization.py",
