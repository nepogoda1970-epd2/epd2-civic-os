...
def main() -> None:
    ...
    replace_once(root / "services/events-messaging-runtime/tests/unit/test_readiness_and_lag.py",
    ...
    replace_once(root / "services/events-messaging-runtime/tests/unit/test_validator_exemptions.py",
