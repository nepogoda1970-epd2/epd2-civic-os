# API-02 handoff upload slot

Purpose: transport only. Do not treat this branch as an acceptance branch.

Upload the exact sealed API-02 candidate ZIP here when ready, together with the developer report, inventory/manifest, and SHA-256 text if available.
