...
- Workflow run: 32372913746
- Commit: 6dec8685406f0aee9c38716fe5cb31384fff5b56
- Environment rc: 0
- Integrity rc: 1
- Smoke rc: 98
- Success-marker rc: 99
...
lrwxrwxrwx 1 root root 13 Aug 20 13:09 /dev/fd -> /proc/self/fd
process-substitution-ok
```

## Integrity log (tail)
```text
sha256sum: EPD2_PILOT02_PUBLIC_SITE_INTEGRATION_AND_UNIFIED_PILOT_PRODUCT_CANDIDATE_0.51.2_C4.zip: No such file or directory
```
