...
- Workflow run: 32157441863
- Commit: 154a4093672875a4072f34d44c60b97120ef652a
- Environment rc: 0
- Integrity rc: 1
- Smoke rc: 98
...
lrwxrwxrwx 1 root root 13 Aug 18 15:55 /dev/fd -> /proc/self/fd
process-substitution-ok
```

## Integrity log (tail)
```text
sha256sum: EPD2_PILOT02_PUBLIC_SITE_INTEGRATION_AND_UNIFIED_PILOT_PRODUCT_CANDIDATE_0.51.1_C3.zip: No such file or directory
```
