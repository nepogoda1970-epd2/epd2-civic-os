...
def test_current_versions_match_expected_skeleton_version() -> None:
    ...
    # canon addition per canon section 25. This round is a canon-only
    # change for CLAUDE-PACK-07 governance; no membership-service or
    # eligibility-service extension code exists yet, so
    # REPOSITORY_VERSION is unchanged at 0.6.0 (both versions again
    # coincidentally match, as they did transiently before, but remain
