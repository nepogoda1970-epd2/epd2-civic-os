import { CaseDetailSurface } from "../../../../components/CaseDetailSurface";
...
/**
 * The case identifier is a route parameter and nothing more. It never reaches
 * the page title, a query string, a stored value or a telemetry field.
 */
export default async function CaseDetailPage({
  ...
  return <CaseDetailSurface caseId={caseId} />;
}
