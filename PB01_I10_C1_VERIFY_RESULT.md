...
- Verdict: **FAIL**
- Workflow run: 32362098771
- Commit: cdcc39922cd0c4c6c1801a0840a14310a263c137
...
file:///tmp/epd2-i10-cleanroom-gcmkiS/EPD2_VCRYPTO-PB01-I10_FINAL_CRYPTOGRAPHIC_PROFILE_FREEZE_AND_RELEASE_READINESS_DECISION_CANDIDATE_0.1_C1/scripts/i10_lib.mjs:10
export function req(c,m){if(!c)throw new Error(m);}
                                     ^

Error: UNDECLARED_I10_ADDITION:node_modules/.bin/playwright
    at req (file:///tmp/epd2-i10-cleanroom-gcmkiS/EPD2_VCRYPTO-PB01-I10_FINAL_CRYPTOGRAPHIC_PROFILE_FREEZE_AND_RELEASE_READINESS_DECISION_CANDIDATE_0.1_C1/scripts/i10_lib.mjs:10:38)
    at file:///tmp/epd2-i10-cleanroom-gcmkiS/EPD2_VCRYPTO-PB01-I10_FINAL_CRYPTOGRAPHIC_PROFILE_FREEZE_AND_RELEASE_READINESS_DECISION_CANDIDATE_0.1_C1/scripts/i10_check_predecessor.mjs:7:49

Node.js v24.19.0
file:///tmp/epd2-i10-cleanroom-gcmkiS/EPD2_VCRYPTO-PB01-I10_FINAL_CRYPTOGRAPHIC_PROFILE_FREEZE_AND_RELEASE_READINESS_DECISION_CANDIDATE_0.1_C1/scripts/i10_lib.mjs:12
...
Error: COMMAND_FAILED:/opt/hostedtoolcache/node/24.19.0/x64/bin/node scripts/i10_check_predecessor.mjs:1
    at run (file:///tmp/epd2-i10-cleanroom-gcmkiS/EPD2_VCRYPTO-PB01-I10_FINAL_CRYPTOGRAPHIC_PROFILE_FREEZE_AND_RELEASE_READINESS_DECISION_CANDIDATE_0.1_C1/scripts/i10_lib.mjs:12:247)
    at file:///tmp/epd2-i10-cleanroom-gcmkiS/EPD2_VCRYPTO-PB01-I10_FINAL_CRYPTOGRAPHIC_PROFILE_FREEZE_AND_RELEASE_READINESS_DECISION_CANDIDATE_0.1_C1/scripts/i10_validate_worker.mjs:8:1

Node.js v24.19.0
file:///tmp/pb01-i10-c1/EPD2_VCRYPTO-PB01-I10_FINAL_CRYPTOGRAPHIC_PROFILE_FREEZE_AND_RELEASE_READINESS_DECISION_CANDIDATE_0.1_C1/scripts/i10_lib.mjs:10
export function req(c,m){if(!c)throw new Error(m);}
                                     ^

Error: I10_WORKER_FAILED
    at req (file:///tmp/pb01-i10-c1/EPD2_VCRYPTO-PB01-I10_FINAL_CRYPTOGRAPHIC_PROFILE_FREEZE_AND_RELEASE_READINESS_DECISION_CANDIDATE_0.1_C1/scripts/i10_lib.mjs:10:38)
    at file:///tmp/pb01-i10-c1/EPD2_VCRYPTO-PB01-I10_FINAL_CRYPTOGRAPHIC_PROFILE_FREEZE_AND_RELEASE_READINESS_DECISION_CANDIDATE_0.1_C1/scripts/i10_validate_current_run.mjs:8:175
